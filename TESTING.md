...
| Component | Expected Behavior | Testing Steps | Actual Result | Fix (if needed) | Screenshot |
| --- | --- | --- | --- | --- | --- |
| **Score** display | The score achieved in the quiz should be correctly displayed as `You scored: x out of 100` | Completed the quiz and noted the score | ✅ No fix needed | ![Screenshot](documentation/testing-results-scorestar.webp) | The score was displayed correctly ![Screenshot](documentation/testing-results-score.webp) |
